...
$domain = @("a1hrq03pdcca60-ats.iot.us-east-1.amazonaws.com","agent.jumpcloud.com","assist.jumpcloud.com","cdn02.jumpcloud.com","chocolatey.org","kickstart.jumpcloud.com","private-kickstart.jumpcloud.com","s3.amazonaws.com")
